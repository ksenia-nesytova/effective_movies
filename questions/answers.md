...
JS может выполнять только одну операцию на момент времени. _Event Loop это то, что позволяет выполнять асинхронные операции в JS._
